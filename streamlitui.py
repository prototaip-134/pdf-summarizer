...
def read_and_save_file():
    ...
    st.session_state["user_input"] = "As a research assistant focused on counting cow bites, you are tasked with summarizing a document. Please provide the following information in your summary: Basic Information (Authors, Publication Year, Journal/Conference, Keywords), Summary, Contributions, Strengths & Weaknesses of the document,  Relevance to counting cow bites (if there is any)"
...
def main():
    ...
    st.divider()
    st.markdown("Note: This is a modified version of [ChatPDF](https://github.com/Anil-matcha/ChatPDF) to summarize papers.")
